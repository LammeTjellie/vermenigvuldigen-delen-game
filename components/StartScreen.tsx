...
const OptionButton: React.FC<{
  ...
  const baseClasses = "px-4 py-2 rounded-lg font-bold text-sm md:text-base shadow-md border-b-4 transform transition-all duration-150 ease-in-out";
  ...
  return (
    <div className="text-center flex flex-col items-center animate-[fade-in_1s_ease-in-out] w-full max-w-2xl">
      <div style={{ transform: 'rotateX(15deg)' }}>
        <h1 className="text-6xl md:text-7xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500"
          style={{ WebkitTextStroke: '3px rgba(0,0,0,0.2)' }}>
          Rekenkampioen
        </h1>
      </div>
      <p className="my-2 text-sm md:text-base text-sky-100 max-w-md">
        Klaar om een rekenwonder te worden? Kies je uitdaging!
      </p>

      <div className="bg-black/20 p-3 rounded-2xl w-full">
        <h2 className="text-lg font-semibold mb-2 text-yellow-300">Kies een moeilijkheidsgraad</h2>
      ...
      <div className="bg-black/20 p-3 rounded-2xl w-full mt-2">
        <h2 className="text-lg font-semibold mb-2 text-yellow-300">Kies een speltype</h2>
